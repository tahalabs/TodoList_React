...
=======
# TodoList_React
A modern, responsive task management app built with React and Tailwind CSS. Add tasks with title, date, time, and priority – all inside a clean modal. Features include toggle completion, delete, priority color indicators, and mobile-friendly design. State managed locally (localStorage ready).
>>>>>>> c4a4d3a774489a2213010709d33740e2f94dce85
